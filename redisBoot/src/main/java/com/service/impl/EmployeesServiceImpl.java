...
import com.config.BloomFilterUtil;
...
public class EmployeesServiceImpl implements EmployeesService {
    ...
    public int create(Employees employees) {
        ...
        if (1>0){
            ...
            bloomFilterUtil.add("employees:"+employees.getName());
    ...
    public Employees getByName(String name) {
        ...
        if (bloomFilterUtil.mightContain("employees:"+name)){
    ...
    @Override
    public void test() {
        bloomFilterUtil.add("张三");
        boolean contain = bloomFilterUtil.mightContain("张三");
